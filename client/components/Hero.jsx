        ...
        <div
            ...
            <div className='grid grid-cols-3 gap-4 max-w-[1240px] m-auto'>
                <div className='col-span-2 flex flex-col justify-center md:items-start w-full px-2 py-8'>
                    ...
                    <h1 className='py-3 text-5xl md:text-7xl font-bold'>Discover, collect, and sell extraordinary NFTs</h1>
                ...
                <div className="max-w-sm bg-zinc-200 border border-slate-300 rounded-xl shadow-xl">
                    ...
                    <div className="p-5">
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Drippels</h5>
                            <p>by Drippels</p>
                        </a>
                    </div>
                </div>
